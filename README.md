...
Live Demo: https://flotiqgatsbyevent1.gatsbyjs.io
...
1. **Start the project from template using [Flotiq CLI]((https://github.com/flotiq/flotiq-cli))**
   ...
   flotiq start [flotiqApiKey] [projectName] https://github.com/flotiq/flotiq-gatsby-event-1.git
    ```
...
2. **You can also start the project from template using Gatsby CLI**
    ...
    ```bash
    gatsby new flotiq-gatsby-event-1 https://github.com/flotiq/flotiq-gatsby-event-1.git
    ```
...
5. **Open the source code and start editing!**
   ...
   Open the `flotiq-gatsby-event-1` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
...
[<img src="https://www.gatsbyjs.com/deploynow.svg" alt="Deploy to Gatsby Cloud">](https://www.gatsbyjs.com/dashboard/deploynow?url=https://github.com/flotiq/flotiq-gatsby-event-1)

You can also deploy this project to [Heroku](https://www.heroku.com/) in 3 minutes:

[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/flotiq/flotiq-gatsby-event-1)
